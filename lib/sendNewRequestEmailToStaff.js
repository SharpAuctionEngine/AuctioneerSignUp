...
var sendNewRequestEmailToStaff = function(mandrill) {
    ...
    return function(userRequestRaw, res, req, adminPanelPromise, next) {
        ...
        var adminpanelpromiseresolve = function(apResponse) {
            ...
            var message = {
                ...
                text: "New Request",
                subject: (process.env.TO_FOH_SUBJECT_PREFIX || ''),
                from_email: userRequestRaw.email,
                from_name: userRequestRaw.username,
                ...
                to: [{
                    ...
                    email: process.env.SEND_EMAIL_TO,
                    name: "SAE",
                    type: "bcc"
                }],
                headers: {
                ...
                // bcc_address: process.env.SEND_EMAIL_TO,
            };
            // console.log('line 85');
