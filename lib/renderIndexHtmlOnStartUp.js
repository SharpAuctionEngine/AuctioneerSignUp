  ...
  return function(stripePlansPromise)
  {
      stripePlansPromise.then(function(result) {
          ...
          var indexHtmlPromise     = fsp.writeFile('./public/index.html', IndexHtmlTemplate.render({
              ...
              termsConditionsModalHtml: fs.readFileSync('./public/terms_and_conditions.html', 'utf-8')||'',
              privacyPolicyModalHtml:   fs.readFileSync('./public/privacy_policy.html', 'utf-8')||'',
          }),'utf-8');
