    ...
    return function (req, res) {
                ...
                var apResponses = function (apResponse) {
                    ...
                    apResponse.objects = (apResponse.objects || []).map(function (house) {
                        ...
                        return {
                            ...
                            email: house.email,
                            name: house.name,
                            physical_location: house.physical_location,
                            username: house.username,
                            auc_bal_params: house.auc_bal_params
                        };
                    ...
                    console.log({
                        email: email_num_result
                    });
                    console.log({
                        domain: domain_num_result
                    });
                    console.log({
                        apResponse_num_results: apResponse.num_results
                    });
                    ...
                    if (apResponse.num_results) {
                        resolve({
                            domain_num_result: domain_num_result,
                            email_num_result: email_num_result,
                            auc_bal_params: apResponse.objects[0].auc_bal_params
                        });
                    } else {
                        resolve({
                            domain_num_result: domain_num_result,
        ...
        isDomainAvailable.then(function (apResponse) {
            res.send({
                ...
                auc_bal_params: apResponse.domain_num_result ? apResponse.auc_bal_params : 'No information'
