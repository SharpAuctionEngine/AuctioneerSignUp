...
var insertToPostgre=function(customerPromise,username,email,house_name,house_url,userRequestRaw) {
       ...
       customerPromise.then(function(customer) {
            // asynchronously called
             db.sync().then(function() {
                ...
                UserCreate.then(resolve);
                UserCreate.catch(reject);
                stripePromise.then(console.log).catch(console.error);
