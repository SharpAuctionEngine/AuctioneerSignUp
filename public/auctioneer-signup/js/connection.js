...
sforce.internal.Debug = function() {
    ...
    this.println = function(s, type) {
        ...
        if (this.win === null || !this.win.document) {
            this.output = null;
            this.win = window.open((typeof window.UserContext != "undefined") ? UserContext.getUrl('/soap/ajax/36.0/debugshell.html') : '/soap/ajax/36.0/debugshell.html', '',
...
sforce.Connection = function() {
    ...
    this.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/36.0") : "/services/Soap/u/36.0";
};
...
sforce.connection.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/36.0") : "/services/Soap/u/36.0";
